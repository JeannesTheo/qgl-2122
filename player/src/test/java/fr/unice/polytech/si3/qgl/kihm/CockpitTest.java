...
import fr.unice.polytech.si3.qgl.kihm.equipment.Canon;
...
class CockpitTest {
    ...
    void sailorsName() {
        ...
        System.out.println(cockpit.getGame().getSailors());
    ...
    @Test
    void shipCanon() {
        cockpit.initGame("{\"ship\": {\"type\": \"ship\",\"life\": 100,\"position\": {\"x\": 0,\"y\": 0,\"orientation\": 0},\"name\": \"Les copaings d'abord!\",\"entities\":[{\"x\":0, \"y\":1, \"type\":\"canon\"}],\"deck\": {\"width\": 3.2, \"length\":2,\"z\":25},\"shape\": {\"type\": \"circle\",\"radius\": 20,\"orientation\": 0}}}");
        assertEquals(new Ship("Les copaings d'abord!", 100, new Position(0, 0, 0), new Ellipse2D.Double(-20, -20, 40, 40), new Deck(3, 2), List.of(new Canon(0, 1))), cockpit.getGame().getShip());
    }
