...
import fr.unice.polytech.si3.qgl.kihm.serializers.WorldDeserializer;
...
public class Parser {
    ...
    public Parser() {
        ...
        mapModule.addDeserializer(World.class, new WorldDeserializer());
        ...
        this.objectMapper.registerModule(mapModule);
    ...
    public static String fileToString(String path) {
        return fileToString(path, 0, 250);
    }
    ...
    private static String fileToString(String path, int firstLine, int lastLine) {
        ...
        try {
            ...
            System.out.println("Le fichier n'est pas au bon endroit i.e. chemin depuis la racine du projet nécessaire");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return sb.toString();
